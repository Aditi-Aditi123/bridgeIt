...
// const Sidebar = ({ sections, activeSection, onSelectSection, onSectionCreated, onSectionDeleted, onSectionPinned, onLogout, user, theme, onToggleTheme, onOpenSettings }) => {
...
//                     onClick={(e) => handlePinSection(e, sec._id)}
//                   >
//                     {sec.pinned ? '📌 Unpin section' : '📌 Pin section'}
//                   </button>
//                   <button
//                     className="section-dropdown-item danger"
//                     onClick={(e) => handleDeleteSection(e, sec._id)}
//                   >
//                     🗑 Delete section
//                   </button>
//                 </div>
...
const Sidebar = ({ sections, activeSection, onSelectSection, onSectionCreated, onSectionDeleted, onSectionPinned, onLogout, user, theme, onToggleTheme, onOpenSettings }) => {
  ...
  return (
    <div className="sidebar">
      ...
      {/* New section input — must stay within sidebar width at all times */}
      {showInput && (
        <div
